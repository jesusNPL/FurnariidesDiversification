...
tree <- read.nexus("./examples/Test_tree.tre")
...
plot(-InfTemp[,"Age"], InfTemp[,"Temperature"], xlab = "", ylab = "Temperature (°C)", 
...
attach("./examples/Test_treeM_complete_results_PastTemperature.Rdata")
...
attach("./examples/Test_treeM_complete_results_PastAndeanAltitude.Rdata")
mean.results <- final_table_tree_file[[1]][order(as.numeric(final_table_tree_file[[1]][,"AICc"])),]
std.err.results <- final_table_tree_file[[2]][order(as.numeric(final_table_tree_file[[2]][,"AICc"])),]
...
attach("./examples/Test_treeM_complete_results_PastSeaLevel.Rdata")
mean.results <- final_table_tree_file[[1]][order(as.numeric(final_table_tree_file[[1]][,"AICc"])),]
std.err.results <- final_table_tree_file[[2]][order(as.numeric(final_table_tree_file[[2]][,"AICc"])),]
