...
plot(-InfTemp[,"Age"], f.lamb.mean(InfTemp[,"Age"]), ty = "l", col = "chartreuse3", 
     ...
     xlab = "Time (Myrs ago)", ylab = "Speciation (green) and extinction (red) rates", 
     cex.axis = 0.8, bty = "n")
...
lines(-InfTemp[,"Age"], f.mu.mean(InfTemp[,"Age"]), ty = "l", col = "red", lwd = 1, 
      yaxt = "n", xlab = "Time (Myrs ago)", 
      ylab = "Speciation (blue) and extinction (red) rates", cex.axis = 0.8, bty = "n")
lines(-InfTemp[,"Age"], f.mu.low(InfTemp[,"Age"]), ty = "l", col = "red", lwd = 1, 
      lty = "dotted", yaxt = "n")
lines(-InfTemp[,"Age"], f.mu.high(InfTemp[,"Age"]), ty = "l", col = "red", lwd = 1, 
      lty = "dotted", yaxt = "n")
# add vertical lines to delineate geological periods/epochs/stages
abline(v = c(-298.9, -252.2, -201.3, -145, -100.5, -66, -56, -47.8, -33.9, -28.1, -23.03, 
             -15.97, -11.62, -5.33, -2.58), col = "grey", lty = "dotted", lwd = "1") 
